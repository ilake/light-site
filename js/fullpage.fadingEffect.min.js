...
window.fp_fadingEffectExtension = function() {
    ...
    function x(e) { e.detail ? (l = !1, C()) : (l = a.autoScrolling, N()) }
    ...
    function B() { n = "all " + i + "ms " + f.easingcss3;
        var e = b("slides") ? H(g) : "",
            t = b("sections") ? H(m) : "";
        A(h, e + t) }
    ...
    function N() { f.fadingEffect = a.fadingEffect, _() || (O(), window.scrollTo(0, 0), d.silentScroll(0)) }
    e.update = function(e) { r.remove(c(y)), i = e, B() }, e.turnOn = N, e.turnOff = C, e.apply = O, e.c = d.c;
    var k = e["common".charAt(0)];
    return "complete" === document.readyState && k("fadingEffect"), window.addEventListener("load", function() { k("fadingEffect") }), e };
